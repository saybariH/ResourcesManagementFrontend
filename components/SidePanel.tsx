          ...
          <nav id="app-nav-main" className="app-nav app-nav-main flex-grow-1">
            ...
            >
              <li className="nav-item">
                ...
                <Link className={(currentRoute.pathname === '/')? 'nav-link  active':'nav-link '} href="/">
              ...
              <li className="nav-item">
                {/*<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->*/}
                <Link className={(currentRoute.pathname === '/docs')? 'nav-link  active':'nav-link '} href="/docs">
                  <span className="nav-icon">
                    <svg
                      width="1em"
                      height="1em"
              ...
              <li className="nav-item">
                {/*<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->*/}
                <Link className={(currentRoute.pathname === '/table')? 'nav-link  active':'nav-link '} href="/table">
                  <span className="nav-icon">
                    <svg
                      width="1em"
                      height="1em"
